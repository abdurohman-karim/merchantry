    ...
    <div class="row mb-3">
        <div class="col-lg-8 col-sm-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Создать расход</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8 col-lg-8 offset-lg-2 offset-md-2 col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Новый расход</h4>
                    <form action="{{ route('transactions.outcome') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 product-info">
                                        <p class="badge badge-soft-secondary text-secondary font-size-11">
                                            Расходная цена : <span class="formattedOutcomePrice">0</span> SUM
                                        </p>
                                        <p class="badge badge-soft-secondary text-secondary font-size-11">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="button">Выбрать магазин</label>
                                            <select class="select2 form-control" data-placeholder="Выберите магазин" name="merchant_id">
                                                <option></option>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateProductInfo(selectElement) {
                ...
                var selectedPrice = selectedOption.data('sale-price') || 0; // Update to use sale price for outcome
                var selectedCount = selectedOption.data('count') || 0;

                selectElement.closest('.row').find('.formattedOutcomePrice').text(numberWithCommas(selectedPrice));
